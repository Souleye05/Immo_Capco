    ...
    <head>
        ...
        <style>
            ...
            .center-content {
                ...
                flex-direction: column;
                align-items: center;
                gap: 30px; /* Espace entre le bouton et le logo */
            }
            ...
            .login-button {
                ...
                font: bold;
                cursor: pointer;
                margin-bottom: 20px; /* Ajoute un espace supplémentaire sous le bouton */
            }
    ...
    <body>
        ...
        <div class="bg-container">
            ...
            <div class="center-content">
                ...
                <a href="/admin/login" class="login-button ">Se connecter</a>
