<!-- resources/views/filament/tables/columns/versement-actions.blade.php -->
<div class="flex space-x-2">
    @php
    $payment = $getRecord()->payment;
    $latestVersement = $payment->versement()->latest()->first();
    $isFullPayment = $payment->amount_paid >= $payment->amount && $getRecord()->id === $latestVersement?->id;
@endphp

    
    @if($isFullPayment)
        <a href="{{ route('versements.download-quittance', $getRecord()) }}" 
    ...
    @else
        <a href="{{ route('versements.download-recu', $getRecord()) }}" 
