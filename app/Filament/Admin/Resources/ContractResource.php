...
use App\Filament\Admin\Resources\ContractResource\RelationManagers;
...
class ContractResource extends Resource
{
    ...
    // Permissions spécifiques pour la gestion des contrats
                            ...
                            ->schema([
                                Forms\Components\Select::make('tenant_id')
                                    ...
                                    ->createOptionUsing(function (array $data) {
                                        $tenantUserService = app(\App\Services\TenantUserService::class);
                                        ...
                                        if (!$user->email_verified_at) {
                                            Notification::make()
                                                ...
                                                ->body("Un email d'invitation a été envoyé à {$data['email']} pour activer son compte.")
                                                ->success()
                                                ->send();
                                        } else {
                                            Notification::make()
                                                ->title('Locataire associé')
                                                ->body("Le locataire {$data['name']} a été associé à cette agence.")
                                                ->success()
                                                ->send();
                                        }
