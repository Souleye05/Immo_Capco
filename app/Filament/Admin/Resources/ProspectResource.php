...
class ProspectResource extends Resource
{
    ...
    // Permissions spécifiques pour la gestion des prospects
    protected static function getViewPermission(): string
    {
        return 'view_prospects';
    }

    protected static function getCreatePermission(): string
    {
        return 'view_prospects'; // Même permission pour voir et créer
    }

    protected static function getEditPermission(): string
    {
        return 'edit_prospects';
    }

    protected static function getDeletePermission(): string
    {
        return 'edit_prospects'; // Même permission pour modifier et supprimer
    }
    ...
    // Scoping personnalisé - les prospects sont globaux (pas de filtrage par agence)
    public static function getEloquentQuery(): Builder
    {
        ...
        if ($tenant = \Filament\Facades\Filament::getTenant()) {
            \Log::info('ProspectResource getEloquentQuery called with tenant: ' . $tenant->name . ' (ID: ' . $tenant->id . ')');
        } else {
            \Log::info('ProspectResource getEloquentQuery called but no tenant found');
        }

        // Les prospects sont globaux - pas de filtrage par agence
        // Tous les prospects sont visibles pour toutes les agences
        return $query;
    }
