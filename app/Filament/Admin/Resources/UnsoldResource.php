...
use App\Filament\Admin\Resources\UnsoldResource\Pages;
use App\Filament\Admin\Resources\UnsoldResource\RelationManagers;
use App\Models\Flat;
...
class UnsoldResource extends Resource
{
    ...
    // Permissions spécifiques pour la gestion des impayés
    protected static function getViewPermission(): string
    {
        return 'manage_unsolds'; // Permission commerciale pour les impayés
    }

    protected static function getCreatePermission(): string
    {
        return 'manage_unsolds';
    }
    ...
    // Scoping personnalisé pour filtrer par agence via tenant
    public static function getEloquentQuery(): Builder
    {
        ...
        if ($tenant = \Filament\Facades\Filament::getTenant()) {
            ...
            \Log::info('UnsoldResource getEloquentQuery called with tenant: ' . $tenant->name . ' (ID: ' . $tenant->id . ')');

            $query->whereHas('tenant', function ($subQuery) use ($tenant) {
                $subQuery->where('agency_id', $tenant->id);
            });
        } else {
            \Log::info('UnsoldResource getEloquentQuery called but no tenant found');
        }
